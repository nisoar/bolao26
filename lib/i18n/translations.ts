...
const translations = {
  ...
  nav: {
    ...
    leaderboard: { en: "Leaderboard", pt: "Classificacao", es: "Clasificacion", it: "Classifica", fr: "Classement" },
    ...
    users: { en: "Users", pt: "Usuarios", es: "Usuarios", it: "Utenti", fr: "Utilisateurs" },
    ...
    subtitle: { en: "Score Prediction Challenge", pt: "Desafio de Previsao de Placares", es: "Desafio de Prediccion de Marcadores", it: "Sfida di Previsione dei Risultati", fr: "Defi de Prediction de Scores" },
    calendar: { en: "Calendar", pt: "Calendario", es: "Calendario", it: "Calendario", fr: "Calendrier" },
  },
  ...
  home: {
    ...
    competeDesc: { en: "Climb the leaderboard and become the prediction champion", pt: "Suba na classificacao e torne-se o campeao de previsoes", es: "Sube en la clasificacion y conviertete en el campeon de predicciones", it: "Scala la classifica e diventa il campione di previsioni", fr: "Grimpez au classement et devenez le champion des predictions" },
    getStarted: { en: "Get Started", pt: "Comecar", es: "Comenzar", it: "Inizia", fr: "Commencer" },
    viewLeaderboard: { en: "View Leaderboard", pt: "Ver Classificacao", es: "Ver Clasificacion", it: "Vedi Classifica", fr: "Voir le Classement" },
    scoringRules: { en: "Scoring Rules", pt: "Regras de Pontuacao", es: "Reglas de Puntuacion", it: "Regole di Punteggio", fr: "Regles de Points" },
  },

  // ===== AUTH =====
  auth: {
    loginTitle: { en: "Login", pt: "Entrar", es: "Iniciar sesion", it: "Accedi", fr: "Connexion" },
    loginDesc: { en: "Enter your credentials to access your predictions", pt: "Insira suas credenciais para acessar suas previsoes", es: "Ingresa tus credenciales para acceder a tus predicciones", it: "Inserisci le tue credenziali per accedere alle tue previsioni", fr: "Entrez vos identifiants pour acceder a vos predictions" },
    ...
    noAccount: { en: "Don't have an account?", pt: "Nao tem uma conta?", es: "No tienes una cuenta?", it: "Non hai un account?", fr: "Vous n'avez pas de compte ?" },
    signUpTitle: { en: "Sign up", pt: "Cadastro", es: "Registro", it: "Registrazione", fr: "Inscription" },
    signUpDesc: { en: "Create your account to start predicting", pt: "Crie sua conta para comecar a prever", es: "Crea tu cuenta para empezar a predecir", it: "Crea il tuo account per iniziare a prevedere", fr: "Creez votre compte pour commencer a predire" },
    displayName: { en: "Display Name", pt: "Nome de Exibicao", es: "Nombre Visible", it: "Nome Visualizzato", fr: "Nom d'affichage" },
    ...
    alreadyHaveAccount: { en: "Already have an account?", pt: "Ja tem uma conta?", es: "Ya tienes una cuenta?", it: "Hai gia un account?", fr: "Vous avez deja un compte ?" },
    passwordsNoMatch: { en: "Passwords do not match", pt: "As senhas nao coincidem", es: "Las contrasenas no coinciden", it: "Le password non corrispondono", fr: "Les mots de passe ne correspondent pas" },
    ...
    emailAlreadyInUse: { en: "This email is already registered.", pt: "Este e-mail ja esta cadastrado.", es: "Este correo ya esta registrado.", it: "Questa email e gia registrata.", fr: "Cet e-mail est deja enregistre." },
    ...
    displayNameTooLong: { en: "Name must be 50 characters or less.", pt: "O nome deve ter no maximo 50 caracteres.", es: "El nombre debe tener 50 caracteres o menos.", it: "Il nome deve avere al massimo 50 caratteri.", fr: "Le nom ne doit pas depasser 50 caracteres." },
    ...
    sendResetLink: { en: "Send Reset Link", pt: "Enviar Link de Redefinicao", es: "Enviar Enlace", it: "Invia Link di Reimpostazione", fr: "Envoyer le lien" },
    ...
    passwordUpdatedDesc: { en: "Your password has been updated. You can now sign in with your new password.", pt: "Sua senha foi atualizada. Agora voce pode entrar com sua nova senha.", es: "Tu contrasena ha sido actualizada. Ahora puedes iniciar sesion con tu nueva contrasena.", it: "La tua password e stata aggiornata. Ora puoi accedere con la tua nuova password.", fr: "Votre mot de passe a ete mis a jour. Vous pouvez maintenant vous connecter avec votre nouveau mot de passe." },
    ...
    resetLinkExpired: { en: "This reset link has expired or is invalid. Please request a new one.", pt: "Este link de redefinicao expirou ou e invalido. Por favor, solicite um novo.", es: "Este enlace de restablecimiento expiro o es invalido. Por favor, solicita uno nuevo.", it: "Questo link di reimpostazione e scaduto o non e valido. Richiedine uno nuovo.", fr: "Ce lien de reinitialisation a expire ou est invalide. Veuillez en demander un nouveau." },
  },

  // ===== DASHBOARD =====
  dashboard: {
    title: { en: "Your Predictions", pt: "Suas Previsoes", es: "Tus Predicciones", it: "Le Tue Previsioni", fr: "Vos Predictions" },
    subtitle: { en: "Submit your score predictions before each match starts", pt: "Envie suas previsoes de placar antes de cada jogo comecar", es: "Envia tus predicciones de marcador antes de que comience cada partido", it: "Invia le tue previsioni di risultato prima dell'inizio di ogni partita", fr: "Soumettez vos predictions de score avant le debut de chaque match" },
    noMatches: { en: "No matches available yet. Check back soon!", pt: "Nenhuma partida disponivel ainda. Volte em breve!", es: "Aun no hay partidos disponibles. Vuelve pronto!", it: "Nessuna partita disponibile ancora. Torna presto!", fr: "Aucun match disponible pour le moment. Revenez bientot !" },
    matchStarted: { en: "Match has started. Predictions are locked.", pt: "A partida comecou. As previsoes estao bloqueadas.", es: "El partido ha comenzado. Las predicciones estan bloqueadas.", it: "La partita e iniziata. Le previsioni sono bloccate.", fr: "Le match a commence. Les predictions sont verrouillees." },
    yourPrediction: { en: "Your Prediction:", pt: "Sua Previsao:", es: "Tu Prediccion:", it: "La Tua Previsione:", fr: "Votre Prediction :" },
    ...
    updatePrediction: { en: "Update Prediction", pt: "Atualizar Previsao", es: "Actualizar Prediccion", it: "Aggiorna Previsione", fr: "Mettre a jour la prediction" },
    submitPrediction: { en: "Submit Prediction", pt: "Enviar Previsao", es: "Enviar Prediccion", it: "Invia Previsione", fr: "Soumettre la prediction" },
  },

  // ===== CALENDAR =====
  calendar: {
    title: { en: "Match Calendar", pt: "Calendario de Partidas", es: "Calendario de Partidos", it: "Calendario Partite", fr: "Calendrier des Matchs" },
  ...
  // ===== LEADERBOARD =====
  leaderboard: {
    title: { en: "Leaderboard", pt: "Classificacao", es: "Clasificacion", it: "Classifica", fr: "Classement" },
    subtitle: { en: "See who's leading the prediction challenge", pt: "Veja quem lidera o desafio de previsoes", es: "Mira quien lidera el desafio de predicciones", it: "Scopri chi guida la sfida di previsioni", fr: "Decouvrez qui mene le defi de predictions" },
    rankings: { en: "Rankings", pt: "Classificacao", es: "Clasificacion", it: "Classifica", fr: "Classement" },
    ...
    rank: { en: "Rank", pt: "Posicao", es: "Posicion", it: "Posizione", fr: "Rang" },
    player: { en: "Player", pt: "Jogador", es: "Jugador", it: "Giocatore", fr: "Joueur" },
    predictions: { en: "Predictions", pt: "Previsoes", es: "Predicciones", it: "Previsioni", fr: "Predictions" },
    points: { en: "Points", pt: "Pontos", es: "Puntos", it: "Punti", fr: "Points" },
    noPredictions: { en: "No predictions yet. Be the first to join!", pt: "Nenhuma previsao ainda. Seja o primeiro a participar!", es: "Aun no hay predicciones. Se el primero en participar!", it: "Nessuna previsione ancora. Sii il primo a partecipare!", fr: "Aucune prediction pour le moment. Soyez le premier a participer !" },
  ...
  // ===== SCORING RULES =====
  scoring: {
    title: { en: "Scoring Rules", pt: "Regras de Pontuacao", es: "Reglas de Puntuacion", it: "Regole di Punteggio", fr: "Regles de Points" },
    subtitle: { en: "Learn how points are awarded", pt: "Aprenda como os pontos sao concedidos", es: "Aprende como se otorgan los puntos", it: "Scopri come vengono assegnati i punti", fr: "Decouvrez comment les points sont attribues" },
    pointSystem: { en: "Point System", pt: "Sistema de Pontuacao", es: "Sistema de Puntuacion", it: "Sistema di Punteggio", fr: "Systeme de Points" },
    pointSystemDesc: { en: "How you earn points for your predictions", pt: "Como voce ganha pontos com suas previsoes", es: "Como ganas puntos con tus predicciones", it: "Come guadagni punti con le tue previsioni", fr: "Comment vous gagnez des points pour vos predictions" },
    exactScore: { en: "Exact Score", pt: "Placar Exato", es: "Marcador Exacto", it: "Risultato Esatto", fr: "Score Exact" },
    exactScoreDesc: { en: "You correctly predicted the exact score. For example, if you predict 2-1 and the match ends 2-1, you earn 25 points.", pt: "Voce previu corretamente o placar exato. Por exemplo, se voce preve 2-1 e o jogo termina 2-1, voce ganha 25 pontos.", es: "Predijiste correctamente el marcador exacto. Por ejemplo, si predices 2-1 y el partido termina 2-1, ganas 25 puntos.", it: "Hai previsto correttamente il risultato esatto. Ad esempio, se prevedi 2-1 e la partita finisce 2-1, guadagni 25 punti.", fr: "Vous avez correctement predit le score exact. Par exemple, si vous predisez 2-1 et le match se termine 2-1, vous gagnez 25 points." },
    ...
    yourPrediction: { en: "Your Prediction:", pt: "Sua Previsao:", es: "Tu Prediccion:", it: "La Tua Previsione:", fr: "Votre Prediction :" },
    readyToPredict: { en: "Ready to start predicting?", pt: "Pronto para comecar a prever?", es: "Listo para empezar a predecir?", it: "Pronto a iniziare a prevedere?", fr: "Pret a commencer a predire ?" },
    joinNow: { en: "Join Now", pt: "Participar Agora", es: "Unirse Ahora", it: "Unisciti Ora", fr: "Rejoindre Maintenant" },
  },

  // ===== ADMIN =====
  admin: {
    panel: { en: "Admin Panel", pt: "Painel de Administracao", es: "Panel de Administracion", it: "Pannello di Amministrazione", fr: "Panneau d'Administration" },
    ...
    instructions: { en: "Instructions", pt: "Instrucoes", es: "Instrucciones", it: "Istruzioni", fr: "Instructions" },
    accessDenied: { en: "Access Denied", pt: "Acesso Negado", es: "Acceso Denegado", it: "Accesso Negato", fr: "Acces Refuse" },
    accessDeniedDesc: { en: "You do not have permission to access the admin panel.", pt: "Voce nao tem permissao para acessar o painel de administracao.", es: "No tienes permiso para acceder al panel de administracion.", it: "Non hai il permesso di accedere al pannello di amministrazione.", fr: "Vous n'avez pas la permission d'acceder au panneau d'administration." },
    accessDeniedInfo: { en: "This area is restricted to administrators only. If you believe you should have access, please contact the system administrator.", pt: "Esta area e restrita apenas a administradores. Se voce acredita que deveria ter acesso, entre em contato com o administrador do sistema.", es: "Esta area esta restringida solo a administradores. Si crees que deberias tener acceso, contacta al administrador del sistema.", it: "Quest'area e riservata solo agli amministratori. Se ritieni di dover avere accesso, contatta l'amministratore di sistema.", fr: "Cette zone est reservee aux administrateurs uniquement. Si vous pensez que vous devriez y avoir acces, veuillez contacter l'administrateur du systeme." },
    usersManagement: { en: "Users Management", pt: "Gerenciamento de Usuarios", es: "Gestion de Usuarios", it: "Gestione Utenti", fr: "Gestion des Utilisateurs" },
    usersManagementDesc: { en: "Manage all registered users and admin permissions", pt: "Gerencie todos os usuarios registrados e permissoes de administrador", es: "Gestiona todos los usuarios registrados y permisos de administrador", it: "Gestisci tutti gli utenti registrati e i permessi di amministratore", fr: "Gerez tous les utilisateurs inscrits et les permissions d'administrateur" },
    allUsers: { en: "All Users", pt: "Todos os Usuarios", es: "Todos los Usuarios", it: "Tutti gli Utenti", fr: "Tous les Utilisateurs" },
    allUsersDesc: { en: "View and manage user accounts and permissions", pt: "Visualize e gerencie contas de usuarios e permissoes", es: "Ver y gestionar cuentas de usuarios y permisos", it: "Visualizza e gestisci account utente e permessi", fr: "Voir et gerer les comptes utilisateurs et les permissions" },
    ...
    actions: { en: "Actions", pt: "Acoes", es: "Acciones", it: "Azioni", fr: "Actions" },
    noUsers: { en: "No users found", pt: "Nenhum usuario encontrado", es: "No se encontraron usuarios", it: "Nessun utente trovato", fr: "Aucun utilisateur trouve" },
    ...
    matchNumber: { en: "Match Number", pt: "Numero da Partida", es: "Numero del Partido", it: "Numero Partita", fr: "Numero du Match" },
    ...
    noMatches: { en: "No matches available. Click \"Add New Match\" to get started.", pt: "Nenhuma partida disponivel. Clique em \"Adicionar Nova Partida\" para comecar.", es: "No hay partidos disponibles. Haz clic en \"Agregar Nuevo Partido\" para comenzar.", it: "Nessuna partita disponibile. Clicca su \"Aggiungi Nuova Partita\" per iniziare.", fr: "Aucun match disponible. Cliquez sur \"Ajouter un Nouveau Match\" pour commencer." },
    ...
    instructionEdit: { en: "Click \"Edit\" on any match card to update team names, match number, or date.", pt: "Clique em \"Editar\" em qualquer cartao de partida para atualizar nomes, numero ou data.", es: "Haz clic en \"Editar\" en cualquier tarjeta para actualizar nombres, numero o fecha.", it: "Clicca su \"Modifica\" su qualsiasi scheda per aggiornare nomi, numero o data.", fr: "Cliquez sur \"Modifier\" sur n'importe quelle carte pour mettre a jour les noms, le numero ou la date." },
    ...
    instructionDelete: { en: "Click \"Delete\" to remove a match and all its predictions permanently.", pt: "Clique em \"Excluir\" para remover uma partida e todas as suas previsoes permanentemente.", es: "Haz clic en \"Eliminar\" para eliminar un partido y todas sus predicciones permanentemente.", it: "Clicca su \"Elimina\" per rimuovere una partita e tutte le sue previsioni permanentemente.", fr: "Cliquez sur \"Supprimer\" pour supprimer un match et toutes ses predictions definitivement." },
  },
} as const
